...
sentiment_model = pipeline(
    "text-classification",
    model="models/models--distilbert--distilbert-base-uncased-finetuned-sst-2-english/snapshots/714eb0fa89d2f80546fda750413ed43d93601a13",
)


# analyzer = sentiment_model("text-classification",
#                 model=model_path)
